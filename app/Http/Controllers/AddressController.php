...
class AddressController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $data['states'] = State::where('status', 0)->where('country_id', $data['address_data']->country_id)->get();
        $data['cities'] = City::where('status', 0)->where('state_id', $data['address_data']->state_id)->get();
...
//        return ;
    ...
    public function getStates(Request $request) {
        $states = State::where('status', 0)->where('country_id', $request->country_id)->get();
    ...
    public function getCities(Request $request) {
        $cities = City::where('status', 0)->where('state_id', $request->state_id)->get();
