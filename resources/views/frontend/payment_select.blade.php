                                    ...
                                    <div class="col-xxl-8 col-xl-10 mx-auto">
                                        <div class="row gutters-10">
                                            ...
                                            @if (get_setting('upi_payment') == 1)
                                                <div class="col-6 col-md-4">
                                                    <div id="qr_code"></div>
                                                    <form name="qrCodeForm" id="qrCodeForm" action="" method="post">
                                                        <input type="hidden" name="txnAmount" id="txnAmount" value="{{ $total }}" class="form-control" placeholder="Enter Txn Amount" readonly><br>
                                                        <input type="hidden" name="customerName" id="customerName" value="{{ Auth::user()->name }}" class="form-control" required>
                                                        <input type="hidden" name="customerMobile" id="customerMobile" value="{{ Auth::user()->phone }}" maxlength="10" class="form-control" required><br>
                                                        <input type="hidden" name="customerEmail" id="customerEmail" value="{{ Auth::user()->email }}" class="form-control" required><br>
                                                    </form>
                                                </div>
                                            @endif
...
@section('script')
    ...
    <script type="text/javascript">
        /*$(document).ready(function() {
            ...
            data.append("customerMobile", $('#customerMobile').val());
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ route('checkout.generate_qr_code') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
